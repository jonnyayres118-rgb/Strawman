...
A scenario can contain unresolved roles while being designed. The internal workspace shows verified subtotal economics, the exact missing roles and an unresolved-role count for the UI. A final scenario investment is unavailable until every included role is fully costed. Once complete, the internal view exposes final revenue, cost, GP and GM. Client proposal generation receives only the final investment and client-safe team/deployment fields such as role, layer, phase, total days, weeks and days per week. Individual BUY/SELL rates never cross that boundary.
